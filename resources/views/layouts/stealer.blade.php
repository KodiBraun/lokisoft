            ...
            <div class="container">
                <div class="">
                    ...
                    <ul class="nav navbar-nav hidden-sm hidden-xs top-navbar-items">
                        <li><a href="#">Скачать ASI</a></li>
                        <li><a href="#">Скачать SF</a></li>
                        <li><a href="/downloadlogs">Скачать логи</a></li>
                        <li><a href="#" data-toggle="modal" data-target="#custom-width-modal">Очистить базу</a></li>
{{--                        <li><a href="#" data-toggle="modal" data-target="#panel-modal">Топ пользователей</a></li>--}}
                    </ul>
                    <!-- Top nav Right menu -->
        ...
        <div id="page-right-content">
            ...
            <div class="container">
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-sm-6">
                                    <div class="widget-inline-box text-center">
                                        <h3 class="m-t-10"><i class="text-primary mdi mdi-counter"></i> <b data-plugin="counterup">{{ $logs->count() }}</b></h3>
                                        <p class="text-muted">Всего строк</p>
                                    </div>
                                </div>

                                <div class="col-lg-3 col-sm-6">
                                    <div class="widget-inline-box text-center">
                                        <h3 class="m-t-10"><i class="text-custom mdi mdi-counter"></i> <b data-plugin="counterup">{{ $count_logs }}</b></h3>
                                        <p class="text-muted">Строк за неделю</p>
                                    </div>
                                </div>

                                <div class="col-lg-3 col-sm-6">
                                    <div class="widget-inline-box text-center">
                                        <h3 class="m-t-10"><i class="text-info mdi mdi-counter"></i> <b data-plugin="counterup">{{ $logs_yesterday }}</b></h3>
                                        <p class="text-muted">Строк за вчера</p>
                                    </div>
                                </div>

                                <div class="col-lg-3 col-sm-6">
                                    <div class="widget-inline-box text-center b-0">
                                        <h3 class="m-t-10"><i class="text-danger mdi mdi-counter"></i> <b data-plugin="counterup">{{ $logs_today }}</b></h3>
                                        <p class="text-muted">Строк за сегодня</p>
                                    </div>
                                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            <h4 class="header-title m-t-0 m-b-20">Логи</h4>
                        </div>
                    </div> <!-- end row -->
                    <div class="row">
        ...
        <div class="modal-dialog" style="width:55%;">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="custom-width-modalLabel">Очистить базу от логов?</h4>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary waves-effect waves-light"><a href="/deletelogs" style='color:white;'>Удалить</a></button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
